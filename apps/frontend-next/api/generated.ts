...
const injectedRtkApi = api.injectEndpoints({
  endpoints: (build) => ({
    ...
    CreateCourse: build.mutation<CreateCourseMutation, CreateCourseMutationVariables>({
      query: (variables) => ({ document: CreateCourseDocument, variables })
    }),
    ...
    RemoveCourse: build.mutation<RemoveCourseMutation, RemoveCourseMutationVariables>({
      query: (variables) => ({ document: RemoveCourseDocument, variables })
    }),
    RemoveReview: build.mutation<RemoveReviewMutation, RemoveReviewMutationVariables>({
      query: (variables) => ({ document: RemoveReviewDocument, variables })
    }),
    RemoveUser: build.mutation<RemoveUserMutation, RemoveUserMutationVariables>({
      query: (variables) => ({ document: RemoveUserDocument, variables })
    }),
